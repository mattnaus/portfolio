...
<label for={id} class="uppercase relative text-slate-700 font-medium flex items-center mr-5">
...
<style>
	...
	label .check:after {
		@apply top-2 left-2 h-3 w-3 rounded-full bg-white;
	}
</style>
